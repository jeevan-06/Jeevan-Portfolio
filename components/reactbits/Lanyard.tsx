...
function Band({
  ...
  const cardMap = useMemo(() => {
    ...
    if (frontImage && frontTex && (frontTex as any).image) drawFitted((frontTex as any).image, FRONT_UV_RECT);
    if (backImage && backTex && (backTex as any).image) drawFitted((backTex as any).image, BACK_UV_RECT);
