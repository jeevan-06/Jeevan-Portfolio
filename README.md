...
| **Styling** | **Tailwind CSS** | Utility-first styling with Tailwind CSS alongside scoped CSS modules and tokens. |
...
| **Smooth Scrolling**| **Lenis** | Provides a single `requestAnimationFrame` loop for silky smooth scrolling. |
